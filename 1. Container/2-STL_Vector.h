...
#ifndef l3vi4th4n_2_STL_VECTOR_H
#define l3vi4th4n_2_STL_VECTOR_H
...
{
public:
	typedef _Alloc alloccator_type;
	alloccator_type get_allocator() const { return alloccator_type(); }
...
#endif // !l3vi4th4n_2_STL_VECTOR_H
